 ...
 */
@Service
public class ClientStatementImpl extends AbstractReportGenerator implements ClientStatement{
	...
	public String doTheReport(String entityId, String fromDate, String toDate)
	    ...
	    final File outputFilename = new File(ClientStatement.class.getSimpleName() + ".pdf");
	...
	/**
	  ...
	  public MasterReport getReportDefinition(){
	    try{
	      ...
	      final URL reportDefinitionURL = classloader.getResource("com/mozido/reports/report/pentaho/" + propertyGetter.getProperty(PropertyGetter.CLIENT_STATEMENT));
	  ...
	  public Map<String, Object> getReportParameters(){
	    ...
	    parameters.put("CustomerID", this.restaurantID);
