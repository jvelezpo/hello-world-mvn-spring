 ...
 */
@Service
public class CustomerSummaryImpl extends AbstractReportGenerator implements
		CustomerSummary {
	...
	public String doTheReport(String entityId, String fromDate, String toDate)
		...
		final File outputFilename = new File(CustomerSummary.class.getSimpleName() + ".pdf");
		...
		try {
			...
			final URL reportDefinitionURL = classloader
					.getResource("com/mozido/reports/report/pentaho/"
							+ propertyGetter.getProperty(PropertyGetter.CUSTOMER_SUMMARY));
