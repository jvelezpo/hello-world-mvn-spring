...
public class Sample1 extends AbstractReportGenerator{
  ...
  public MasterReport getReportDefinition(){
    try{
      ...
      final URL reportDefinitionURL = classloader.getResource("com/mozido/reports/report/pentaho/EOD_Print.prpt");
  ...
  public Map<String, Object> getReportParameters(){
    ...
    parameters.put("RestaurantID", "200000000000001");
    parameters.put("StartDate", "2014-03-27 00:00:00");
    parameters.put("EndDate", "2014-03-28 21:00:00");
  ...
  public String doTheReport() throws IOException, ReportProcessingException{
	    // Create an output filename
	    final File outputFilename = new File(Sample1.class.getSimpleName() + ".pdf");
