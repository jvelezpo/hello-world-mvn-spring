 ...
 */
@Service
public class EodPrintImpl extends AbstractReportGenerator implements EodPrint {
	...
	public String doTheReport(String entityID, String fromDate, String toDate) throws IOException, ReportProcessingException {
	    ...
	    final File outputFilename = new File(EodPrint.class.getSimpleName() + ".pdf");
	...
	/**
	  ...
	  public MasterReport getReportDefinition(){
	    try{
	      ...
	      final URL reportDefinitionURL = classloader.getResource("com/mozido/reports/report/pentaho/" + propertyGetter.getProperty(PropertyGetter.EOD_REPORT));
