 ...
 */
@Service
public class RestaurantSummaryImpl extends AbstractReportGenerator implements RestaurantSummary {
	...
	public String doTheReport(String entityID, String fromDate, String toDate)
		...
		final File outputFilename = new File(RestaurantSummary.class.getSimpleName() + ".pdf");
		...
		try {
			...
			final URL reportDefinitionURL = classloader
					.getResource("com/mozido/reports/report/pentaho/"
							+ propertyGetter.getProperty(PropertyGetter.RESTAURANT_SUMMARY));
